...
class AppointmentService {
    ...
    func getAppointments() {
        ...
        pastAppointments.append(Appointment(providerFirstName: "Louis", providerLastName: "Guernsey", providerSpecialty: "Specialty B", providerId: "205", dateAndTime: Date().addingTimeInterval(-6431432), address: "1600 Rockland Rd, Ste 1302, Wilmington, DE 19803", isAsthmaAppointment: false))
        ...
        pastAppointments.append(Appointment(providerFirstName: "German", providerLastName: "Hoover", providerSpecialty: "Specialty D", providerId: "3472", dateAndTime: Date().addingTimeInterval(-8156113), address: "1600 Rockland Rd, Ste 1302, Wilmington, DE 19803", isAsthmaAppointment: true))
        ...
        futureAppointments.append(Appointment(providerFirstName: "German", providerLastName: "Hoover", providerSpecialty: nil, providerId: "3472", dateAndTime: Date().addingTimeInterval(754323), address: "1600 Rockland Rd, Ste 1302, Wilmington, DE 19803", isAsthmaAppointment: true))
